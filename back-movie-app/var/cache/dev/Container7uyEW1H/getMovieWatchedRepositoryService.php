 ...
 */
class getMovieWatchedRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MovieWatchedRepository' shared autowired service.
     *
     * @return \App\Repository\MovieWatchedRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MovieWatchedRepository.php';

        return $container->privates['App\\Repository\\MovieWatchedRepository'] = new \App\Repository\MovieWatchedRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
