 ...
 */
class getMovieWantedRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MovieWantedRepository' shared autowired service.
     *
     * @return \App\Repository\MovieWantedRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MovieWantedRepository.php';

        return $container->privates['App\\Repository\\MovieWantedRepository'] = new \App\Repository\MovieWantedRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
